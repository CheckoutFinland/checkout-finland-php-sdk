...
class ClientTest extends TestCase
{
    ...
    public function testRevertCitPaymentAuthorizationHold()
    {
        ...
        $revertCitPaymentAuthHoldRequest = (new RevertCitPaymentAuthHoldRequest())
            ->setTransactionId($transactionId);

        $this->assertTrue($revertCitPaymentAuthHoldRequest->validate());

        $revertResponse = $client->revertCitPaymentAuthorizationHold($revertCitPaymentAuthHoldRequest);
    ...
    public function testRevertCitPaymentAuthorizationHoldException()
    {
        ...
        $revertCitPaymentAuthHoldRequestException = (new RevertCitPaymentAuthHoldRequest())
            ->setTransactionId($transactionId);
        ...
        try {
            $client = $this->client;
            $client->revertCitPaymentAuthorizationHold($revertCitPaymentAuthHoldRequestException);
