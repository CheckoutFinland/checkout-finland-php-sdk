 ...
 */
class CitPaymentRequest implements \JsonSerializable, RequestInterface
{
     ...
     * @param string $stamp
     *
     * @return CitPaymentRequest Return self to enable chaining.
     */
    public function setStamp(?string $stamp): CitPaymentRequest
    {
        $this->stamp = $stamp;
     ...
     * @return CitPaymentRequest Return self to enable chaining.
     */
    public function setReference(?string $reference): CitPaymentRequest
    {
     ...
     * @return CitPaymentRequest Return self to enable chaining.
     */
    public function setAmount(?int $amount): CitPaymentRequest
    {
        $this->amount = $amount;
     ...
     * @return CitPaymentRequest Return self to enable chaining.
     */
    public function setCurrency(?string $currency): CitPaymentRequest
    {
     ...
     * @return CitPaymentRequest Return self to enable chaining.
     */
    public function setLanguage(?string $language): CitPaymentRequest
    {
     ...
     * @return CitPaymentRequest Return self to enable chaining.
     */
    public function setItems(?array $items): CitPaymentRequest
    {
     ...
     * @return CitPaymentRequest Return self to enable chaining.
     */
    public function setCustomer(?Customer $customer): CitPaymentRequest
    {
     ...
     * @return CitPaymentRequest Return self to enable chaining.
     */
    public function setDeliveryAddress(?Address $deliveryAddress): CitPaymentRequest
    {
     ...
     * @return CitPaymentRequest Return self to enable chaining.
     */
    public function setInvoicingAddress(?Address $invoicingAddress): CitPaymentRequest
    {
     ...
     * @return CitPaymentRequest Return self to enable chaining.
     */
    public function setRedirectUrls(?CallbackUrl $redirectUrls): CitPaymentRequest
    {
     ...
     * @return CitPaymentRequest Return self to enable chaining.
     */
    public function setCallbackUrls(?CallbackUrl $callbackUrls): CitPaymentRequest
    {
     ...
     */
    public function setToken(string $token): CitPaymentRequest
    {
        $this->token = $token;
